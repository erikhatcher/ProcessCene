...
public class ProcessCene extends PApplet {
  ...
  public void setup() {
    ...
    TextAnalyzer text_analyzer = new LuceneAnalyzer(); // new org.processcene.solr.SolrAnalyzer();

    frameRate(10);
    fill(black);

    slides.add(new LoveLuceneSlide(this));
    slides.add(new SimilaritySlide("Similarity", this));
...
//      slides.add(new org.processcene.SplashSlide("About Me", white,
...
//      slides.add(new org.processcene.AboutProcessCene("About org.processcene.ProcessCene", this).setShowOnTOC(false));
//
//    slides.add(new org.processcene.SplashSlide("\"It's Just Search\": features of Lucene", white,
//        new PImage[] {its_just_search_results, its_just_search_grouping}, "", this));
//
//    slides.add(new org.processcene.lucene.InvertedIndexSlide("Inverted Index", this));
//
...
//      slides.add(new org.processcene.BulletPointsSlide("Language Capabilities",
//          new String[] { "i18n / ICU / character folding", "word decompounding", "stemming", "phonetic"}, bullet_image, null, this).setShowOnTOC(false));
//
//    slides.add(new org.processcene.BulletPointsSlide("Other Index Types",
...
//      slides.add(new org.processcene.BulletPointsSlide("Filtering",
//          new String[] { "non-scoring", "efficient skipping", "caching"}, bullet_image, null, this).setShowOnTOC(false));
//      slides.add(new org.processcene.BulletPointsSlide("Relevancy Scoring",
//          new String[] {"TF/IDF", "BM25", "Function boosting"}, bullet_image, null, this).setShowOnTOC(false));
//
//    slides.add(new org.processcene.BulletPointsSlide("Core Lucene Ecosystem",
...
//
//    slides.add(new org.processcene.BulletPointsSlide("Lucene Inside",
//        new String[] {"Solr", "elasticsearch", "OpenSearch", "Lucidworks", "Atlas Search", "..."}, bullet_image, null,this));
//      slides.add(new org.processcene.BulletPointsSlide("Solr",
//          new String[] {"Tagger",
...
//      slides.add(new org.processcene.solr.SolrTaggerSlide("Solr Tagger", this).setShowOnTOC(false));
//      slides.add(new org.processcene.BulletPointsSlide("Atlas Search", mist,
...
//      slides.add(new org.processcene.SplashSlide("Atlas Search", mist,
...
//
//    slides.add(new org.processcene.SplashSlide("Go forth and search...", white, qr_code, "https://mdb.link/uberconf", this));
//
//    // * Demonstrate solutions to https://www.mongodb.com/blog/post/three-ways-retailers-use-search-beyond-ecommerce-store
//
//    org.processcene.TableOfContentsSlide toc_slide = new org.processcene.TableOfContentsSlide(slides, toc_bullet_image, this);
//    slides.add(1, toc_slide);
//
//    boolean inject_toc_guide = true;
//    if (inject_toc_guide) {
//      List<org.processcene.Slide> updated_slides = new ArrayList<>();
//      for (int i = 0; i < slides.size(); i++) {
//        org.processcene.Slide this_content_slide = slides.get(i);
//
//        // Inject tracking ToC slide before every slide that appears on the ToC
//        if (this_content_slide.getShowOnTOC() && !(this_content_slide instanceof org.processcene.TableOfContentsSlide)) {
//          updated_slides.add(new org.processcene.TableOfContentsSlide(slides,toc_bullet_image,i,this));
//        }
//
